...
class Config:
    ...
    PHASE1_USE_BATCH_API = os.getenv("PHASE1_USE_BATCH_API", "true").lower() in ("1", "true", "yes")
    ...
    PHASE2_USE_BATCH_API = os.getenv("PHASE2_USE_BATCH_API", "true").lower() in ("1", "true", "yes")
